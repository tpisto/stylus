...
module.exports = function(options){
  ...
  return function stylus(req, res, next){
    ...
    if (/\.css$/.test(path)) {
      ...
      // Do tweaks to urls if needed
      if(typeof options.modifyRequestURL != 'undefined') {
        stylusPath = options.modifyRequestURL(stylusPath)
        cssPath = options.modifyRequestURL(cssPath)
      }
